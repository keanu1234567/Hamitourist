...
function ModelViewer({ url, scale = [0.2, 0.2, 0.2], position = [0, 0, 0], setModelError }) {
  ...
  const SpotView = () => {
    ...
    const addCamp3Teleport = (panorama) => {
      const teleportSpot = new PANOLENS.Infospot(500, "https://i.imgur.com/uTh9cBK.png"); // arrow icon
  ...
  const addBackToCamp4 = (panorama) => {
    const backSpot = new PANOLENS.Infospot(400, "https://i.imgur.com/uTh9cBK.png");
    ...
    const addImageInsidePanorama = (panorama, type) => {
      ...
      if (type === "BlackMountain") {
        const models = ["/3dmodels/Scaveola.glb", "/3dmodels/Wendlandia Nervosa.glb"];
        const images = ["https://i.imgur.com/rtdNyCT.png", "https://i.imgur.com/c9KxAbm.png"];
        const positions = [
          [2500, -3600, -750],
          [3000, -5000, -6000],
        ];
        ...
        models.forEach((model, i) => {
          ...
          infospot.addEventListener("click", () => {
            ...
            setActiveModel({ url: model, scale: modelSettings[i].scale, position: modelSettings[i].position });
      ...
      /* ----------------- PEAK ----------------- */
      if (type === "Peak") {
        const peakModels = ["/3dmodels/kopfii.glb", "/3dmodels/hamiguitan pitcher plant.glb"];
        const modelSettings = [
          { scale: [0.1, 0.1, 0.1], position: [0, -1.2, 0.5] },
          { scale: [0.2, 0.2, 0.2], position: [0.3, -1.2, 0] },
        ];
        const images = ["https://i.imgur.com/7rVup0Z.png", "https://i.imgur.com/FZzh0ap.png"];
        const positions = [
          [2700, -2500, -1200],
          [3000, -2700, -3700],
        ];
    ...
    return (
      <div className="spotview-container">
        <div ref={containerRef} className={`panorama-container ${blurPanorama ? "blurred" : ""}`} />
  ...
  {modelInfo && (
    <div className="model-info-section" onWheel={(e) => e.stopPropagation()}>
